...
// Create a new variable named "shouldOrderMore", and use a comparison operator to assign a boolean value to this variable. If "inStock" is less than 20, the variable should be true, otherwise it should be false. You MUST use a comparison operator.
...
// Create a new variable "vegetables" and assign it to an Array of 5 different vegetables, represented by their names as Strings.
var vegetables = ["peas", "carrots", "beets", "onions", "brussels sprouts"];
...
// Create a new variable "fruits" and assign it to an Array of 7 different fruits.
var fruits = ["apples", "oranges", "grapes", "kiwis", "plums", "cherries", "pears"];
...
// Create a new variable called "groceryStore" and assign to it an object literal with two keys: name, and isOpen. The value for name should the string 'King Soopers' (or your favorite grocery store), and the value for isOpen should be true. Which other key value pairs would make sense to add to this object?
var groceryStore = {
    name: "King Soopers",
    isOpen: true
};
console.log(groceryStore);
    ...
    // We could also add location, store hours, parking availability, etc.

// Write the code to add the key of location, with the value of 'Denver, Colorado'. Use dot notation to do this. DO NOT modify your code from above.
